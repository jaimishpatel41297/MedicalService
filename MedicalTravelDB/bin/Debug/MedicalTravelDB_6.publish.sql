...
GO
ALTER TABLE [dbo].[Sales]
    ADD CONSTRAINT [FK_Doctor_Sales_DoctorID] FOREIGN KEY ([DoctorID]) REFERENCES [dbo].[Doctors] ([DoctorID]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[Sales]
    ADD CONSTRAINT [FK_Treatment_Sales_TreatmentID] FOREIGN KEY ([TreatmentID]) REFERENCES [dbo].[Treatment] ([TreatmentID]) ON DELETE CASCADE;
